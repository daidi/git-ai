document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            nav_features: "Features", hero_badge: "v1.0.0 Released", hero_title: "Commit first,<br>think <span>later.</span>", hero_desc: "Don't wait for AI. Keep coding while Git AI writes your commit messages in the background. <strong>The zero-friction async polisher.</strong>",
        ...
        "zh-cn": {
            nav_features: "核心特性", hero_badge: "v1.0.0 最新发布", hero_title: "先提交，<br>后<span>思考。</span>", hero_desc: "告别漫长的同步等待。你只管写代码，让 Git AI 在后台默默为你写好提交信息。<strong>零摩擦的异步润色体验。</strong>",
        ...
        "zh-tw": {
            nav_features: "核心特性", hero_badge: "v1.0.0 最新發布", hero_title: "先提交，<br>後<span>思考。</span>", hero_desc: "告別漫長的同步等待。你只管寫程式，讓 Git AI 在背景默默為你寫好提交訊息。<strong>零摩擦的非同步潤飾體驗。</strong>",
        ...
        fr: {
            nav_features: "Caractéristiques", hero_badge: "v1.0.0 Publié", hero_title: "Commettez d'abord,<br>réfléchissez <span>plus tard.</span>", hero_desc: "N'attendez pas l'IA. Continuez à coder pendant que Git AI rédige vos messages de commit en arrière-plan. <strong>Le polisseur asynchrone zéro friction.</strong>",
        ...
        it: {
            nav_features: "Funzionalità", hero_badge: "v1.0.0 Rilasciato", hero_title: "Esegui il commit prima,<br>pensa <span>dopo.</span>", hero_desc: "Non aspettare l'IA. Continua a programmare mentre Git AI scrive i tuoi messaggi di commit in background. <strong>Il lucidatore asincrono senza attrito.</strong>",
        ...
        de: {
            nav_features: "Funktionen", hero_badge: "v1.0.0 Veröffentlicht", hero_title: "Zuerst committen,<br>später <span>denken.</span>", hero_desc: "Warten Sie nicht auf die KI. Coden Sie weiter, während Git AI Ihre Commit-Nachrichten im Hintergrund schreibt. <strong>Der reibungslose asynchrone Polierer.</strong>",
        ...
        es: {
            nav_features: "Características", hero_badge: "v1.0.0 Lanzado", hero_title: "Haz commit primero,<br>piensa <span>después.</span>", hero_desc: "No esperes a la IA. Sigue programando mientras Git AI escribe tus mensajes de commit en segundo plano. <strong>El pulidor asíncrono sin fricción.</strong>",
        ...
        ja: {
            nav_features: "機能", hero_badge: "v1.0.0 リリース", hero_title: "先にコミットし、<br>後で<span>考える。</span>", hero_desc: "AIを待つ必要はありません。Git AIがバックグラウンドでコミットメッセージを作成している間も、コーディングを続けましょう。<strong>ゼロフリクションの非同期ポリッシャー。</strong>",
        ...
        ko: {
            nav_features: "기능", hero_badge: "v1.0.0 출시됨", hero_title: "먼저 커밋하고,<br>나중에 <span>생각하세요.</span>", hero_desc: "AI를 기다리지 마세요. Git AI가 백그라운드에서 커밋 메시지를 작성하는 동안 계속 코딩하세요. <strong>마찰 없는 비동기 폴리셔.</strong>",
        ...
        pt: {
            nav_features: "Ressursos", hero_badge: "v1.0.0 Lançado", hero_title: "Faça commit primeiro,<br>pense <span>depois.</span>", hero_desc: "Não espere pela IA. Continue codando enquanto o Git AI escreve suas mensagens de commit em segundo plano. <strong>O polidor assíncrono sem atrito.</strong>",
        ...
        ru: {
            nav_features: "Функции", hero_badge: "Релиз v1.0.0", hero_title: "Сначала коммить,<br>думай <span>потом.</span>", hero_desc: "Не ждите ИИ. Продолжайте кодить, пока Git AI пишет сообщения для коммитов в фоновом режиме. <strong>Асинхронный полировщик без трения.</strong>",
        ...
        ar: {
            nav_features: "الميزات", hero_badge: "تم إصدار v1.0.0", hero_title: "قم بالـ Commit أولاً،<br>وفكر <span>لاحقاً.</span>", hero_desc: "لا تنتظر الذكاء الاصطناعي. استمر في البرمجة بينما يكتب Git AI رسائل الإيداع الخاصة بك في الخلفية. <strong>المُحسّن المتزامن الخالي من الاحتكاك.</strong>",
        ...
        vi: {
            nav_features: "Tính năng", hero_badge: "Đã phát hành v1.0.0", hero_title: "Commit trước,<br>nghĩ <span>sau.</span>", hero_desc: "Đừng chờ đợi AI. Cứ tiếp tục code trong khi Git AI viết thông điệp commit cho bạn ở chế độ nền. <strong>Công cụ trau chuốt bất đồng bộ không độ trễ.</strong>",
        ...
        th: {
            nav_features: "คุณลักษณะ", hero_badge: "ปล่อยเวอร์ชัน v1.0.0", hero_title: "Commit ก่อน,<br>คิดที <span>หลัง.</span>", hero_desc: "ไม่ต้องรอ AI. โค้ดต่อไปในขณะที่ Git AI เขียนข้อความคอมมิตให้คุณในเบื้องหลัง <strong>ตัวช่วยเรียบเรียงแบบอะซิงโครนัสที่ไร้รอยต่อ.</strong>",
        ...
        id: {
            nav_features: "Fitur", hero_badge: "v1.0.0 Dirilis", hero_title: "Commit dulu,<br>pikirkan <span>nanti.</span>", hero_desc: "Tidak perlu menunggu AI. Teruslah ngoding sementara Git AI menulis pesan commit Anda di latar belakang. <strong>Pemoles asinkron tanpa hambatan.</strong>",
