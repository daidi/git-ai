document.addEventListener('DOMContentLoaded', () => {
    ...
    const translations = {
        en: {
            ...
            btn_idea: "Get JetBrains Plugin",
            hero_cli_link: "Terminal maximalist? Get the CLI engine →",
        ...
        zh: {
            ...
            btn_idea: "获取 JetBrains 插件",
            hero_cli_link: "只用终端？查看 CLI 极客安装包 →",
            feat1_title: "零感延迟",
            feat1_desc: "提交命令仅需 12 毫秒。复杂的 LLM 请求全部在被彻底隔离的后台守护进程中静默完成。",
            feat2_title: "实时状态可见",
            feat2_desc: "临时 <code>[⏳]</code> 前缀作为安全锁，在 <code>git log</code> 中直接反馈状态，杜绝代码同步冲突。",
            feat3_title: "自动排队推送",
            feat3_desc: "在润色未结束时执行 <code>git push</code>？推送会被加入队列，等待润色完成后在云端自动分发。",
            feat4_title: "IDE 原生集成",
            feat4_desc: "提供原生的 VS Code 和 IntelliJ IDEA 控制面版，免终端即可查看完整状态监控。",
